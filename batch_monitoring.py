...
def show_batch_status(verbose=False):
    ...
    if verbose:
        ...
        print(f"  CORTEX_BATCH_RESEARCH_ENABLED:         {os.getenv('CORTEX_BATCH_RESEARCH_ENABLED', 'not set')}")
        print(f"  CORTEX_BATCH_RECOMMENDATIONS_ENABLED:  {os.getenv('CORTEX_BATCH_RECOMMENDATIONS_ENABLED', 'not set')}")
        print(f"  CORTEX_BATCH_LEARNING_ENABLED:         {os.getenv('CORTEX_BATCH_LEARNING_ENABLED', 'not set')}")
...
def main():
    ...
    parser.add_argument('--check-batches', '-b', action='store_true', help='Show detailed batch information')
