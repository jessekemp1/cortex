...
- Runs `cortex next` automatically
...
- **Week 1 Data**: `cortex/week1_data.json`
- **Feedback Log**: `~/.cortex/feedback.json`
...
python3 "cortex/cli.py" feedback --action-title "..." --useful yes
```
