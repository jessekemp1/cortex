...
class PortfolioAnalyzer:
    ...
    def _analyze_spec_coverage(self) -> Dict[str, Any]:
        ...
        coverage_pct = (len(documented_projects) / total_projects * 100) if total_projects > 0 else 0
    ...
    def print_report(self, analysis: Dict):
        ...
        for name, proj in analysis["project_analysis"].items():
            ...
            print(f"  Specs: {proj['spec_count']} {'✅' if proj['has_documentation'] else '⚠️ MISSING'}")
        ...
        print(f"Coverage: {specs['coverage_percentage']}% ({specs['projects_with_specs']}/{specs['total_projects']} projects)")
        ...
        print(f"  Prevented: {metrics['mistakes']['prevented']} ({metrics['mistakes']['prevention_rate']}%)")
