...
def detect_stale_items(
    ...
    if goals_path is None:
        # Default: monorepo root GOALS.md
...
def format_compact(briefing: BriefingData, use_color: bool = True) -> str:
    ...
    EMOS status, stale items, and drill-down commands.
    """
    ...
    # Header: fixed width box top
    header_label = "CORTEX"
    header_right = date_str

    # Build header line with date aligned right
