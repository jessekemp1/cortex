...
This is your foundation calibration week. The goal is simple: **use Converx daily and learn your actual patterns**.
...
4. **Quick note any friction**:
   ```bash
   python3 "converx/Grok MVP/cli.py" feedback --log "Friction: ..."
   ```
...
```bash
# Check your progress
python3 "converx/Grok MVP/cli.py" feedback --stats
```
...
python3 "converx/Grok MVP/cli.py" next vortexv2

# With context
python3 "converx/Grok MVP/cli.py" next --with-context

# Log feedback
python3 "converx/Grok MVP/cli.py" feedback --action-title "Action" --useful yes --notes "Notes"

# Quick log
python3 "converx/Grok MVP/cli.py" feedback --log "Quick note"

# Check stats
python3 "converx/Grok MVP/cli.py" feedback --stats

# Check system health
python3 "converx/Grok MVP/cli.py" health

# Show status
python3 "converx/Grok MVP/cli.py" status
```
...
Start with Day 1: Run `converx next` and see what it recommends.
