...
class MiniMaxProvider(BaseProvider):
    """MiniMax provider (OpenAI-compatible, 1M context)."""
    ...
    def __init__(
        ...
        if not resolved_key:
            raise ProviderError("minimax", 0, "MINIMAX_API_KEY not set")
    ...
    def complete(
        ...
        **kwargs: Any,
        ...
        pricing = PRICING.get(model, (0.30, 1.20))
