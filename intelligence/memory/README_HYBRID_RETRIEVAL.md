...
- Implementation: [`intelligence/memory/hybrid_retriever.py`](hybrid_retriever.py)
- Tests: [`tests/test_hybrid_retriever.py`](../../tests/test_hybrid_retriever.py)
- Demo: [`demo_hybrid_retrieval.py`](../../demo_hybrid_retrieval.py)
- PRD: [`docs/AI_ENGINEERING_IMPROVEMENTS_PRD.md`](../../docs/AI_ENGINEERING_IMPROVEMENTS_PRD.md) (Improvement 1)
